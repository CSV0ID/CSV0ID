<!-- ============================================================
     GitHub Profile README — Chinmay Shinde (@CSV0ID)
     chinmayshinde.dev
     ============================================================ -->
...
![Header](https://capsule-render.vercel.app/api?type=waving&color=7F77DD,534AB7&height=200&section=header&text=CHINMAY%20SHINDE&fontSize=52&fontColor=ffffff&fontAlignY=38&desc=Offensive%20Security%20%C2%B7%20Reverse%20Engineering%20%C2%B7%20AI%2FML&descAlignY=58&descSize=16&descColor=ccccff&animation=fadeIn)
...
> CS student from Pune. I reverse engineer systems, break things to understand them,
> and ship security + AI tools that actually do something.
...
Tracks device usage. Runs local ML. Surfaces insights in configurable modes — Hinglish, "Abusive Friend," and more.

![Kotlin](https://img.shields.io/badge/Kotlin-0d0d0d?style=flat-square&logo=kotlin&logoColor=7F77DD)
![TFLite](https://img.shields.io/badge/TFLite-0d0d0d?style=flat-square&logo=tensorflow&logoColor=7F77DD)
...
<h3>🀄 VOIDWEN &nbsp;<sup><code>WIP</code></sup></h3>

**AI agent with Wenyan compression**

Two LLM agent personas, one unified skill. Classical Chinese (文言文) as extreme compression mode. Fully client-side — transformers.js + ONNX.
...
```
OFFENSIVE SECURITY
├── Reverse Engineering    ████████████░░  Android APK · Windows PE · Flutter
├── Static Analysis        ███████████░░░  Malware · Firmware · Obfuscated Code
├── API Recon              █████████████░  Endpoint Extraction · Auth Bypass · Frida
└── Threat Modeling        ████████░░░░░░  Attack Surface · Vuln Chaining

DEVELOPMENT
├── Backend                ████████████░░  Python · FastAPI · Node.js
├── Mobile                 ██████████░░░░  Kotlin · Android
├── Frontend               █████████░░░░░  React · TypeScript · Three.js · GSAP
└── AI/ML                  ████████░░░░░░  LLM APIs · ONNX · TFLite · RAG

TOOLS & INFRA
└── Docker · Railway · Vercel · Cloudflare · Firebase · Frida · Burp Suite
```
